...
void main() {
  ...
  test('review page does not report local-only success for unimplemented actions', () {
    final review = File('web/stitch/screens/review/index.html').readAsStringSync();
    expect(review, isNot(contains("alert('已启动未来7天蒙特卡洛时序模拟')")));
    expect(review, contains('data-unavailable-notice='));
  });
