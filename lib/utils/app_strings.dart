...
class AppStrings {
  static const Map<String, Map<String, String>> _data = {
    ...
    'en': {
      ...
      'focus_header_next': 'NEXT UP',
      'focus_empty_task': 'No more tasks for today',
      'focus_time_remaining': 'Time Left: ',
      'focus_snack_start': 'Starting {task} in {min} min',
      'focus_snack_upcoming': '{task} will start in {min} min...',

      // Micro Task Page
      'micro_title': 'Crystal Pool',
      'micro_ai_suggestion':
          'AI detected 15 mins of free time. Suggested tasks:',
      'micro_btn_fill': 'Auto Fill',
      'micro_btn_add': 'Add Micro Task',
      'micro_dialog_add': 'New Micro Task',
      'micro_dialog_del': 'Delete Task',
      'micro_label_min': 'Est. Minutes:',
      'micro_card_min': 'min',

      // Team Page
      'team_title': 'Collaboration',
      'team_rec_title': 'Golden Collab Window',
      'team_best_time': 'Best Time: Today 15:00 - 16:00',
      'team_btn_book': 'Book Now',
      'team_reason': 'Reason: Everyone is stable w/o conflicts',
      'team_track_title': 'Project Tracking (Dev)',
      'team_btn_add_task': 'Add Task',
      'team_dialog_add': 'New Team Task',
      ...
      // Profile Page
      'profile_title': 'Insights',
      'profile_device': 'Device (Apple/Huawei)',
      'profile_connected': 'Connected',
      'profile_auth': '3rd Party Auth (MCP)',
