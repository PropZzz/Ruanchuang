...
RESERVED_ENDPOINTS = [
    ...
    ("PUT", "/goals/goal-1"),
    ("DELETE", "/goals/goal-1"),
    ("POST", "/goals/goal-1/tasks"),
    ("PUT", "/goals/goal-1/tasks/task-1"),
    ("POST", "/goals/goal-1/schedule-next"),
    ("POST", "/goals/decompose"),
    ("GET", "/team/members"),
    ("POST", "/team/members"),
    ("PUT", "/team/members/member-1"),
    ("DELETE", "/team/members/member-1"),
    ("PUT", "/team/members/member-1/permission"),
    ("GET", "/team/calendars"),
    ("POST", "/team/conflicts"),
